...
def _load_data(dataset_str):
    ...
    for i in range(len(names)):
        ...
        file_path = "/mae_pat/rui.guan/graph_model/FastGCN_pytorch/"
        with open("{}data/ind.{}.{}".format(file_path, dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file(
        "{}data/ind.{}.test.index".format(file_path, dataset_str))
